<aside class=" w-64 bg-[#73946B] text-white min-h-screen shadow-xl/30 inset-shadow-sm h-full">
    ...
    <div class="flex items-center py-6 bg-[#537D5D] shadow-lg/20">  
        <div class="relative w-16 h-16 overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600 mx-4 shadow-lg">
        ...
        <div>
            <h1 class="text-2xl text-[#FAF6E9] font-bold py-4 text-center text-shadow-lg">Counter 1</h1>
        </div>
    </div>
