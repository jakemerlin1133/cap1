...
@section('content')
    ...
    <div class="grid grid-rows-4 gap-4">
        <div class="bg-[#FAF6E9] shadow-lg/20">
            <div class="flex flex-1">
                ...
                <div class="w-full flex justify-center py-12">
                    <div
                        class="relative w-52 h-52 overflow-hidden bg-[#9EBC8A] rounded-full items-center mx-4 shadow-lg">
                    ...
                    {{-- Edit Profile Icon --}}
                    <div class="flex items-end ml-[-3.5rem] mb-[-0.5rem]">
        ...
        <div class="bg-[#FAF6E9] shadow-lg/20">2</div>
        <div class="bg-[#FAF6E9] shadow-lg/20">3</div>
    </div>
@endsection
